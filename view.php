...
<!-- Title -->
<title>Vedeți înregistrarea - Atestate informatică</title>
    ...
    <div class="bemax-area gray-bg pt-65 pb-25">
        <div class="container">
            ...
            <form method="post" action="<?php echo $_SERVER['PHP_SELF'];?>" enctype="multipart/form-data">
                ...
                <center><a href="ura.php"><button type="button" class="btn btn-primary">Du-ma la tabel</button></a></center>
            </form>
