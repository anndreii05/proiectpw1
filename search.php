...
<!-- Title -->
<title>Rezultate cautare - Atestate informatică</title>
            ...
            <table class="table">
                <thead class="thead-dark">
                  <tr>
                     ...
                     <th scope="col" colspan="3">Detalii</th>
                  </tr>
               </thead>
            <tbody>
              <?php while ($row= mysqli_fetch_array($query)){?>
                ...
                <tr>
                    ...
                    <td><?php echo "<a href=\"detalii.php?id=".$row['id']."\">Detalii</a>"?></td>
                </tr>
